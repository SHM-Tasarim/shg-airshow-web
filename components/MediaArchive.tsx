...
const MediaArchive: React.FC<MediaArchiveProps> = ({ lang, onNavigate }) => {
  ...
  // Öncelikli görseller (en önde gösterilecek)
  const priorityItems: MediaItem[] = [
  ...
  return (
    <div className='bg-white dark:bg-background-dark min-h-screen transition-colors duration-500 pb-32 relative'>
      <div className='max-w-7xl mx-auto px-6 pt-16'>
        ...
        {/* Tüm görseller - öncelikliler başta */}
        <section className='columns-1 sm:columns-2 lg:columns-3 gap-8'>
          {[...priorityItems, ...otherItems].map((item, idx) => (
