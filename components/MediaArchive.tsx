...
const MediaArchive: React.FC<MediaArchiveProps> = ({ lang, onNavigate }) => {
  ...
  const mediaItems: MediaItem[] = [
    ...
    { type: "TV", title: "NTV 2024", src: `${R2_URL}/ntv-2024.mp4` },
    ...
    { type: "TV", title: "CNN TURK 2023", src: `${R2_URL}/cnn-turk-2023.mp4` },
    ...
    {
      type: "TV",
      title: "TGRT HABER 2022",
      src: `${R2_URL}/tgrt-haber-2022.mp4`,
    },
    ...
    { type: "TV", title: "NTV 2020", src: `${R2_URL}/ntv-2020.mp4` },
    {
      type: "TV",
      title: "HABER TÜRK 2020",
      src: `${R2_URL}/haber-turk-2020.mp4`,
    },
    { type: "TV", title: "A HABER 2020", src: `${R2_URL}/a-haber-2020.mp4` },
    {
      type: "TV",
      title: "HABER GLOBAL 2020",
      src: `${R2_URL}/haber-global-2020.mp4`,
    },
    { type: "TV", title: "S SPORTS 2020", src: `${R2_URL}/s-sports-2020.mp4` },
    {
      type: "TV",
      title: "TGRT HABER 2020",
      src: `${R2_URL}/tgrt-haber-2020.mp4`,
    },
    { type: "TV", title: "TV100 2020", src: `${R2_URL}/tv100-2020.mp4` },
    { type: "TV", title: "KANAL 26 2020", src: `${R2_URL}/kanal26-2020.mp4` },
    {
      type: "TV",
      title: "TRT WORLD 2020",
      src: `${R2_URL}/trt-world-2020.mp4`,
    },
  ...
  // Lazy loading hook for media items
  ...
  const VideoCard: React.FC<{ item: MediaItem; idx: number }> = ({
    item,
    idx,
  }) => {
        ...
        {isVisible ? (
          ...
          <div className='w-full aspect-video bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center'>
            <div className='text-center'>
              <span className='material-icons text-primary text-5xl mb-2'>
                play_circle
              </span>
              <p className='text-[10px] font-mono font-black text-white/60 tracking-widest uppercase'>
                {item.title}
              </p>
            </div>
          </div>
  ...
  // Image bileşeni - Lazy loading ile
  ...
  return (
    <div className='bg-white dark:bg-background-dark min-h-screen transition-colors duration-500 pb-32 overflow-hidden relative'>
      ...
      {selectedItem && (
        ...
        >
          <button
            className='absolute top-8 right-8 text-white flex items-center gap-2 group z-[110]'
            onClick={() => setSelectedItem(null)}
          >
            <span className='text-[10px] font-black tracking-widest group-hover:text-primary transition-colors uppercase'>
              {content.close}
            </span>
            <span className='material-icons bg-white/10 p-2 rounded-full group-hover:bg-primary transition-colors'>
              close
            </span>
          </button>
          ...
          >
            ...
            <div className='absolute -bottom-12 left-0 right-0 text-center'>
              <p className='text-white font-mono text-xs tracking-[0.3em] uppercase opacity-60'>
                {selectedItem.title}
              </p>
            </div>
          </div>
