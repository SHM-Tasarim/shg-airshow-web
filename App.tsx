            ...
            <div className="max-w-6xl mx-auto px-6">
              <div className="flex flex-col items-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-6">
                  ...
                  <div className="relative w-44 h-24 md:w-52 md:h-28 bg-[#0A1427] backdrop-blur-sm border-2 border-[#cfaa67]/40 rounded-xl flex items-center justify-center overflow-hidden hover:bg-[#0A1427] transition-all duration-300 hover:shadow-[0_0_25px_rgba(207,166,103,0.4)] hover:border-[#cfaa67] group">
                    <img
